...
void R_InitSkyTexCoords( float heightCloud )
{
	...
	if( !Q_stricmp( glConfig.gfxer_string, "GDI Generic" ) && !Q_stricmp( glConfig.version_string, "1.1.0" ) ) {
		// fix skybox drawing on MS software GL implementation
...
void RB_StageIteratorSky( void ) {
	...
	backEnd.skyDrawedThisView = qtrue;
}
