...
typedef struct bot_goalstate_s
{
	...
	//
	int user;									//user using this goal state
...
bot_goalstate_t *botgoalstates[MAX_USERS + 1]; // FIXME: init?
//item configuration
...
int BotChooseLTGItem(int goalstate, vec3_t origin, int *inventory, int travelflags)
{
	...
	areanum = BotReachabilityArea(origin, gs->user);
