 ...
 * desc:		bot AI library
 *
 * $Archive: /source/code/co/app/botai.h $
 *
 *****************************************************************************/

#define BOTLIB_API_VERSION		2

struct aas_usermove_s;
...
typedef struct botlib_import_s
{
	...
	//send a bot user command
	void		(*BotUserCommand)( int user, const char *command );
	//memory allocation
...
typedef struct ai_export_s
{
	...
	void	(*BotEnterChat)(int chatstate, int user, int sendto);
	...
	void	(*BotSetChatName)(int chatstate, char *name, int user);
	//-----------------------------------
	// be_ai_goal.h
	//-----------------------------------
	...
	int		(*BotAllocGoalState)(int user);
...
"maxusers"				"4"					be_interface.c		maximum number of users
