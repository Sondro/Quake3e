...
static qboolean ValidEntityNumber(int num, const char *str)
{
	...
	return qtrue;
} //end of the function BotValidateUserNumber
//===========================================================================
//
// Parameter:				-
// Returns:					-
...
int Export_BotLibSetup( void )
{
	...
	botlibglobals.maxusers =(int) LibVarValue( "maxusers", "64" );
...
//	AAS_ClearShownDebugLines();
	...
	if(newarea != area)
	{
		...
		AAS_TraceUserBBox(origin, end, PRESENCE_CROUCH, -1);
...
/*
	...
	trace = AAS_TraceUserBBox(eye, end, PRESENCE_NORMAL, 1);
...
//		AAS_TraceUserBBox(eye, end, PRESENCE_NORMAL, 1);
	} //end for
	end_time = clock();
...
static void Init_AAS_Export( aas_export_t *aas ) {
	...
	aas->AAS_PredictUserMovement = AAS_PredictUserMovement;
}
