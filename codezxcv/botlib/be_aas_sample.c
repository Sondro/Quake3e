...
// Changes Globals:		-
//===========================================================================
aas_trace_t AAS_TraceUserBBox(vec3_t start, vec3_t end, int presencetype,
																				int passent)
{
...
//	return trace;
} //end of the function AAS_TraceUserBBox
//===========================================================================
// recursive subdivision of the line by the BSP tree.
//
// Parameter:				-
...
// Changes Globals:		-
//===========================================================================
aas_link_t *AAS_LinkEntityUserBBox(vec3_t absmins, vec3_t absmaxs, int entnum, int presencetype)
{
	vec3_t mins, maxs;
...
} //end of the function AAS_LinkEntityUserBBox
//===========================================================================
//
// Parameter:				-
// Returns:					-
