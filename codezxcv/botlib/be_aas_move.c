...
int AAS_OnGround(vec3_t origin, int presencetype, int passent)
{
	...
	trace = AAS_TraceUserBBox(origin, end, presencetype, passent);
...
void AAS_JumpReachRunStart(aas_reachability_t *reach, vec3_t runstart)
{
	...
	//
	AAS_PredictUserMovement(&move, -1, start, PRESENCE_NORMAL, qtrue,
...
float AAS_WeaponJumpZVelocity(vec3_t origin, float radiusdamage)
{
	...
	points *= 0.5;
	//mass of the bot (p_user.c: PutUserInHost)
	mass = 200;
...
// Returns:				aas_usermove_t
// Changes Globals:		-
//===========================================================================
static int AAS_UserMovementPrediction( aas_usermove_t *move,
								...
								const vec3_t mins, const vec3_t maxs, int visualize )
{
	...
	for (n = 0; n < maxframes; n++)
	{
		...
		do
		{
			...
			trace = AAS_TraceUserBBox(org, end, presencetype, entnum);
			//
...
//#endif //AAS_MOVE_DEBUG
			...
			if (trace.fraction < 1.0)
			{
				...
				if (plane->normal[2] == 0 && (jump_frame < 0 || n - jump_frame > 2))
				{
					...
					steptrace = AAS_TraceUserBBox(start, stepend, presencetype, entnum);
					//
...
//#endif //AAS_MOVE_DEBUG
		...
		else if (stopevent & SE_GAP)
		{
			...
			gaptrace = AAS_TraceUserBBox(start, end, PRESENCE_CROUCH, -1);
	...
	//
	return qtrue;
} //end of the function AAS_UserMovementPrediction
...
// Changes Globals:		-
//===========================================================================
int AAS_PredictUserMovement(struct aas_usermove_s *move,
								...
								int stopevent, int stopareanum, int visualize)
{
	...
	return AAS_UserMovementPrediction(move, entnum, origin, presencetype, onground,
										velocity, cmdmove, cmdframes, maxframes,
										frametime, stopevent, stopareanum,
										mins, maxs, visualize);
} //end of the function AAS_PredictUserMovement
...
// Changes Globals:		-
//===========================================================================
int AAS_UserMovementHitBBox(struct aas_usermove_s *move,
								int entnum, vec3_t origin,
								int presencetype, int onground,
								vec3_t velocity, vec3_t cmdmove,
								int cmdframes,
								...
								vec3_t mins, vec3_t maxs, int visualize)
{
	return AAS_UserMovementPrediction(move, entnum, origin, presencetype, onground,
										...
										mins, maxs, visualize);
} //end of the function AAS_UserMovementHitBBox
//===========================================================================
//
// Parameter:			-
// Returns:				-
...
void AAS_TestMovementPrediction(int entnum, vec3_t origin, vec3_t dir)
{
	...
	AAS_PredictUserMovement(&move, entnum, origin, PRESENCE_NORMAL, qtrue,
