...
Loads and prepares a map file for scene drawing.
...
void R_LoadEntities(lump_t *l) {
	...
	// store for reference by the app
...
void R_DrawMissingCubemaps(void)
{
	int i, j;
...
void RE_LoadWorldMap(const char *name) {
	...
	// reset last cascade sun direction so last shadow cascade is redrawed
