...
void R_DrawView(viewParms_t *parms );
void R_DrawDlightCubemaps(const refdef_t *fd);
void R_DrawPshadowMaps(const refdef_t *fd);
void R_DrawSunShadowMaps(const refdef_t *fd, int level);
void R_DrawCubemapSide(int cubemapIndex, int cubemapSide, qboolean subscene );
...
#define MAX_DRAW_COMMANDS	0x40000
