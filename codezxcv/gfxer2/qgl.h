...
#define QGL_1_1_PROCS \
	...
	GLE(void, DisableUserState, GLenum cap) \
	...
	GLE(void, EnableUserState, GLenum cap) \
...
#define QGL_ARB_framebuffer_object_PROCS \
	GLE(void, BindDrawbuffer, GLenum target, GLuint drawbuffer) \
	GLE(void, DeleteDrawbuffers, GLsizei n, const GLuint *drawbuffers) \
	GLE(void, GenDrawbuffers, GLsizei n, GLuint *drawbuffers) \
	GLE(void, DrawbufferStorage, GLenum target, GLenum internalformat, GLsizei width, GLsizei height) \
	...
	GLE(void, FramebufferDrawbuffer, GLenum target, GLenum attachment, GLenum drawbuffertarget, GLuint drawbuffer) \
	...
	GLE(void, DrawbufferStorageMultisample, GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height) \
...
#define QGL_EXT_direct_state_access_PROCS \
	...
	GLE(GLvoid, NamedDrawbufferStorageEXT, GLuint drawbuffer, GLenum internalformat, GLsizei width, GLsizei height) \
	GLE(GLvoid, NamedDrawbufferStorageMultisampleEXT, GLuint drawbuffer, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height) \
	...
	GLE(GLvoid, NamedFramebufferDrawbufferEXT, GLuint framebuffer, GLenum attachment, GLenum drawbuffertarget, GLuint drawbuffer) \
