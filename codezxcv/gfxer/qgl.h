...
#define QGL_Core_PROCS \
	...
	GLE(void, glDisableUserState, GLenum array) \
	...
	GLE(void, glEnableUserState, GLenum array) \
...
#define QGL_Ext_PROCS \
	...
	GLE(void, glUserActiveTextureARB, GLenum texture) \
...
#define QGL_FBO_PROCS \
	GLE(void, glBindDrawbuffer, GLenum target, GLuint drawbuffer) \
	GLE(void, glDeleteFramebuffers, GLsizei n, const GLuint *framebuffers) \
	GLE(void, glDeleteDrawbuffers, GLsizei n, const GLuint *drawbuffers) \
	GLE(void, glGenDrawbuffers, GLsizei n, GLuint *drawbuffers) \
	GLE(void, glDrawbufferStorage, GLenum target, GLenum internalformat, GLsizei width, GLsizei height) \
	GLE(void, glGetDrawbufferParameteriv, GLenum target, GLenum pname, GLint *params) \
	...
	GLE(void, glFramebufferDrawbuffer, GLenum target, GLenum attachment, GLenum drawbuffertarget, GLuint drawbuffer) \
...
#define QGL_FBO_OPT_PROCS \
	GLE(void, glDrawbufferStorageMultisample, GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height) \
