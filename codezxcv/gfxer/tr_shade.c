...
static void DrawMultitextured(const shaderCommands_t *input, int stage ) {
	...
	if (r_vbo->integer ) {
		...
		// or smaller set - which will cause out-of-bounds index access/crash during non-multitexture drawing
		// GL_UserState(1, GLS_NONE );
	}
...
Perform dynamic lighting with another drawing pass
===================
*/
...
void RB_StageIteratorGeneric(void )
{
	...
	else
	{
		...
		GL_UserState(0, CLS_COLOR_ARRAY | CLS_TEXCOORD_ARRAY );
