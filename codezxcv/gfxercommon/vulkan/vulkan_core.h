...
VK_DEFINE_NON_DISPATCHABLE_HANDLE(VkDrawPass)
...
typedef enum VkStructureType {
    ...
    VK_STRUCTURE_TYPE_DRAW_PASS_CREATE_INFO = 38,
    VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO = 39,
    VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO = 40,
    VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_INFO = 41,
    VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO = 42,
    VK_STRUCTURE_TYPE_DRAW_PASS_BEGIN_INFO = 43,
    ...
    VK_STRUCTURE_TYPE_DEVICE_GROUP_DRAW_PASS_BEGIN_INFO = 1000060003,
    ...
    VK_STRUCTURE_TYPE_DRAW_PASS_INPUT_ATTACHMENT_ASPECT_CREATE_INFO = 1000117001,
    VK_STRUCTURE_TYPE_IMAGE_VIEW_USAGE_CREATE_INFO = 1000117002,
    VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO = 1000117003,
    VK_STRUCTURE_TYPE_DRAW_PASS_MULTIVIEW_CREATE_INFO = 1000053000,
    ...
    VK_STRUCTURE_TYPE_DRAW_PASS_CREATE_INFO_2 = 1000109004,
    ...
    VK_STRUCTURE_TYPE_DRAW_PASS_ATTACHMENT_BEGIN_INFO = 1000108003,
    ...
    VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_CONDITIONAL_DRAWING_INFO_EXT = 1000081000,
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CONDITIONAL_DRAWING_FEATURES_EXT = 1000081001,
    VK_STRUCTURE_TYPE_CONDITIONAL_DRAWING_BEGIN_INFO_EXT = 1000081002,
    ...
    VK_STRUCTURE_TYPE_DRAW_PASS_SAMPLE_LOCATIONS_BEGIN_INFO_EXT = 1000143001,
    ...
    VK_STRUCTURE_TYPE_DRAW_PASS_FRAGMENT_DENSITY_MAP_CREATE_INFO_EXT = 1000218002,
    ...
    VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_DRAW_PASS_TRANSFORM_INFO_QCOM = 1000282000,
    VK_STRUCTURE_TYPE_DRAW_PASS_TRANSFORM_BEGIN_INFO_QCOM = 1000282001,
    ...
    VK_STRUCTURE_TYPE_DRAW_PASS_MULTIVIEW_CREATE_INFO_KHR = VK_STRUCTURE_TYPE_DRAW_PASS_MULTIVIEW_CREATE_INFO,
    ...
    VK_STRUCTURE_TYPE_DEVICE_GROUP_DRAW_PASS_BEGIN_INFO_KHR = VK_STRUCTURE_TYPE_DEVICE_GROUP_DRAW_PASS_BEGIN_INFO,
    ...
    VK_STRUCTURE_TYPE_DRAW_PASS_ATTACHMENT_BEGIN_INFO_KHR = VK_STRUCTURE_TYPE_DRAW_PASS_ATTACHMENT_BEGIN_INFO,
    VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2_KHR = VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2,
    VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2_KHR = VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2,
    VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_2_KHR = VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_2,
    VK_STRUCTURE_TYPE_SUBPASS_DEPENDENCY_2_KHR = VK_STRUCTURE_TYPE_SUBPASS_DEPENDENCY_2,
    VK_STRUCTURE_TYPE_DRAW_PASS_CREATE_INFO_2_KHR = VK_STRUCTURE_TYPE_DRAW_PASS_CREATE_INFO_2,
    ...
    VK_STRUCTURE_TYPE_DRAW_PASS_INPUT_ATTACHMENT_ASPECT_CREATE_INFO_KHR = VK_STRUCTURE_TYPE_DRAW_PASS_INPUT_ATTACHMENT_ASPECT_CREATE_INFO,
...
typedef enum VkAccessFlagBits {
    ...
    VK_ACCESS_CONDITIONAL_DRAWING_READ_BIT_EXT = 0x00100000,
...
typedef enum VkPipelineStageFlagBits {
    ...
    VK_PIPELINE_STAGE_CONDITIONAL_DRAWING_BIT_EXT = 0x00040000,
...
typedef enum VkBufferUsageFlagBits {
    ...
    VK_BUFFER_USAGE_CONDITIONAL_DRAWING_BIT_EXT = 0x00000200,
...
typedef enum VkDrawPassCreateFlagBits {
    VK_DRAW_PASS_CREATE_TRANSFORM_BIT_QCOM = 0x00000002,
    VK_DRAW_PASS_CREATE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF
} VkDrawPassCreateFlagBits;
typedef VkFlags VkDrawPassCreateFlags;
...
typedef enum VkCommandBufferUsageFlagBits {
    ...
    VK_COMMAND_BUFFER_USAGE_DRAW_PASS_CONTINUE_BIT = 0x00000002,
...
typedef struct VkDrawPassCreateInfo {
    VkStructureType                   sType;
    const void*                       pNext;
    VkDrawPassCreateFlags           flags;
    uint32_t                          attachmentCount;
...
typedef struct VkDrawPassBeginInfo {
    VkStructureType        sType;
    const void*            pNext;
    VkDrawPass           drawPass;
    VkFramebuffer          framebuffer;
...
typedef VkResult (VKAPI_PTR *PFN_vkCreateDrawPass)(VkDevice device, const VkDrawPassCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDrawPass* pDrawPass);
typedef void (VKAPI_PTR *PFN_vkDestroyDrawPass)(VkDevice device, VkDrawPass drawPass, const VkAllocationCallbacks* pAllocator);
typedef void (VKAPI_PTR *PFN_vkGetDrawAreaGranularity)(VkDevice device, VkDrawPass drawPass, VkExtent2D* pGranularity);
...
typedef void (VKAPI_PTR *PFN_vkCmdBeginDrawPass)(VkCommandBuffer commandBuffer, const VkDrawPassBeginInfo* pDrawPassBegin, VkSubpassContents contents);
typedef void (VKAPI_PTR *PFN_vkCmdNextSubpass)(VkCommandBuffer commandBuffer, VkSubpassContents contents);
typedef void (VKAPI_PTR *PFN_vkCmdEndDrawPass)(VkCommandBuffer commandBuffer);
...
VKAPI_ATTR VkResult VKAPI_CALL vkCreateDrawPass(
    VkDevice                                    device,
    const VkDrawPassCreateInfo*               pCreateInfo,
    const VkAllocationCallbacks*                pAllocator,
    VkDrawPass*                               pDrawPass);

VKAPI_ATTR void VKAPI_CALL vkDestroyDrawPass(
    VkDevice                                    device,
    VkDrawPass                                drawPass,
    const VkAllocationCallbacks*                pAllocator);

VKAPI_ATTR void VKAPI_CALL vkGetDrawAreaGranularity(
    VkDevice                                    device,
    VkDrawPass                                drawPass,
...
VKAPI_ATTR void VKAPI_CALL vkCmdBeginDrawPass(
    VkCommandBuffer                             commandBuffer,
    const VkDrawPassBeginInfo*                pDrawPassBegin,
...
VKAPI_ATTR void VKAPI_CALL vkCmdEndDrawPass(
    VkCommandBuffer                             commandBuffer);
...
typedef struct VkDeviceGroupDrawPassBeginInfo {
    VkStructureType    sType;
    const void*        pNext;
    uint32_t           deviceMask;
    uint32_t           deviceDrawAreaCount;
    const VkRect2D*    pDeviceDrawAreas;
} VkDeviceGroupDrawPassBeginInfo;
...
typedef struct VkDrawPassInputAttachmentAspectCreateInfo {
    VkStructureType                            sType;
    const void*                                pNext;
    uint32_t                                   aspectReferenceCount;
    const VkInputAttachmentAspectReference*    pAspectReferences;
} VkDrawPassInputAttachmentAspectCreateInfo;
...
typedef struct VkDrawPassMultiviewCreateInfo {
    VkStructureType    sType;
    const void*        pNext;
    uint32_t           subpassCount;
...
typedef struct VkDrawPassCreateInfo2 {
    VkStructureType                    sType;
    const void*                        pNext;
    VkDrawPassCreateFlags            flags;
    uint32_t                           attachmentCount;
...
typedef struct VkDrawPassAttachmentBeginInfo {
    VkStructureType       sType;
    const void*           pNext;
    uint32_t              attachmentCount;
    const VkImageView*    pAttachments;
} VkDrawPassAttachmentBeginInfo;
...
typedef VkResult (VKAPI_PTR *PFN_vkCreateDrawPass2)(VkDevice device, const VkDrawPassCreateInfo2* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDrawPass* pDrawPass);
typedef void (VKAPI_PTR *PFN_vkCmdBeginDrawPass2)(VkCommandBuffer commandBuffer, const VkDrawPassBeginInfo*      pDrawPassBegin, const VkSubpassBeginInfo*      pSubpassBeginInfo);
...
typedef void (VKAPI_PTR *PFN_vkCmdEndDrawPass2)(VkCommandBuffer commandBuffer, const VkSubpassEndInfo*        pSubpassEndInfo);
...
VKAPI_ATTR VkResult VKAPI_CALL vkCreateDrawPass2(
    VkDevice                                    device,
    const VkDrawPassCreateInfo2*              pCreateInfo,
    const VkAllocationCallbacks*                pAllocator,
    VkDrawPass*                               pDrawPass);

VKAPI_ATTR void VKAPI_CALL vkCmdBeginDrawPass2(
    VkCommandBuffer                             commandBuffer,
    const VkDrawPassBeginInfo*                pDrawPassBegin,
...
VKAPI_ATTR void VKAPI_CALL vkCmdEndDrawPass2(
    VkCommandBuffer                             commandBuffer,
    const VkSubpassEndInfo*                     pSubpassEndInfo);
...
typedef VkDrawPassMultiviewCreateInfo VkDrawPassMultiviewCreateInfoKHR;
...
typedef VkDeviceGroupDrawPassBeginInfo VkDeviceGroupDrawPassBeginInfoKHR;
...
typedef VkDrawPassAttachmentBeginInfo VkDrawPassAttachmentBeginInfoKHR;



#define VK_KHR_create_drawpass2 1
#define VK_KHR_CREATE_DRAWPASS_2_SPEC_VERSION 1
#define VK_KHR_CREATE_DRAWPASS_2_EXTENSION_NAME "VK_KHR_create_drawpass2"
typedef VkDrawPassCreateInfo2 VkDrawPassCreateInfo2KHR;
...
typedef VkResult (VKAPI_PTR *PFN_vkCreateDrawPass2KHR)(VkDevice device, const VkDrawPassCreateInfo2* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDrawPass* pDrawPass);
typedef void (VKAPI_PTR *PFN_vkCmdBeginDrawPass2KHR)(VkCommandBuffer commandBuffer, const VkDrawPassBeginInfo*      pDrawPassBegin, const VkSubpassBeginInfo*      pSubpassBeginInfo);
...
typedef void (VKAPI_PTR *PFN_vkCmdEndDrawPass2KHR)(VkCommandBuffer commandBuffer, const VkSubpassEndInfo*        pSubpassEndInfo);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR VkResult VKAPI_CALL vkCreateDrawPass2KHR(
    VkDevice                                    device,
    const VkDrawPassCreateInfo2*              pCreateInfo,
    const VkAllocationCallbacks*                pAllocator,
    VkDrawPass*                               pDrawPass);

VKAPI_ATTR void VKAPI_CALL vkCmdBeginDrawPass2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkDrawPassBeginInfo*                pDrawPassBegin,
    const VkSubpassBeginInfo*                   pSubpassBeginInfo);
...
VKAPI_ATTR void VKAPI_CALL vkCmdEndDrawPass2KHR(
    VkCommandBuffer                             commandBuffer,
    const VkSubpassEndInfo*                     pSubpassEndInfo);
#endif
...
typedef enum VkPerformanceCounterScopeKHR {
    ...
    VK_PERFORMANCE_COUNTER_SCOPE_DRAW_PASS_KHR = 1,
    VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_KHR = 2,
    VK_QUERY_SCOPE_COMMAND_BUFFER_KHR = VK_PERFORMANCE_COUNTER_SCOPE_COMMAND_BUFFER_KHR,
    VK_QUERY_SCOPE_DRAW_PASS_KHR = VK_PERFORMANCE_COUNTER_SCOPE_DRAW_PASS_KHR,
...
typedef VkDrawPassInputAttachmentAspectCreateInfo VkDrawPassInputAttachmentAspectCreateInfoKHR;
...
typedef enum VkDebugReportObjectTypeEXT {
    ...
    VK_DEBUG_REPORT_OBJECT_TYPE_DRAW_PASS_EXT = 18,
...
#define VK_EXT_conditional_drawing 1
#define VK_EXT_CONDITIONAL_DRAWING_SPEC_VERSION 2
#define VK_EXT_CONDITIONAL_DRAWING_EXTENSION_NAME "VK_EXT_conditional_drawing"

typedef enum VkConditionalDrawingFlagBitsEXT {
    VK_CONDITIONAL_DRAWING_INVERTED_BIT_EXT = 0x00000001,
    VK_CONDITIONAL_DRAWING_FLAG_BITS_MAX_ENUM_EXT = 0x7FFFFFFF
} VkConditionalDrawingFlagBitsEXT;
typedef VkFlags VkConditionalDrawingFlagsEXT;
typedef struct VkConditionalDrawingBeginInfoEXT {
    VkStructureType                   sType;
    const void*                       pNext;
    VkBuffer                          buffer;
    VkDeviceSize                      offset;
    VkConditionalDrawingFlagsEXT    flags;
} VkConditionalDrawingBeginInfoEXT;

typedef struct VkPhysicalDeviceConditionalDrawingFeaturesEXT {
    VkStructureType    sType;
    void*              pNext;
    VkBool32           conditionalDrawing;
    VkBool32           inheritedConditionalDrawing;
} VkPhysicalDeviceConditionalDrawingFeaturesEXT;

typedef struct VkCommandBufferInheritanceConditionalDrawingInfoEXT {
    VkStructureType    sType;
    const void*        pNext;
    VkBool32           conditionalDrawingEnable;
} VkCommandBufferInheritanceConditionalDrawingInfoEXT;

typedef void (VKAPI_PTR *PFN_vkCmdBeginConditionalDrawingEXT)(VkCommandBuffer commandBuffer, const VkConditionalDrawingBeginInfoEXT* pConditionalDrawingBegin);
typedef void (VKAPI_PTR *PFN_vkCmdEndConditionalDrawingEXT)(VkCommandBuffer commandBuffer);

#ifndef VK_NO_PROTOTYPES
VKAPI_ATTR void VKAPI_CALL vkCmdBeginConditionalDrawingEXT(
    VkCommandBuffer                             commandBuffer,
    const VkConditionalDrawingBeginInfoEXT*   pConditionalDrawingBegin);

VKAPI_ATTR void VKAPI_CALL vkCmdEndConditionalDrawingEXT(
    VkCommandBuffer                             commandBuffer);
#endif
...
typedef struct VkDrawPassSampleLocationsBeginInfoEXT {
    VkStructureType                          sType;
    const void*                              pNext;
...
} VkDrawPassSampleLocationsBeginInfoEXT;
...
#define VK_QCOM_draw_pass_shader_resolve 1
#define VK_QCOM_DRAW_PASS_SHADER_RESOLVE_SPEC_VERSION 4
#define VK_QCOM_DRAW_PASS_SHADER_RESOLVE_EXTENSION_NAME "VK_QCOM_draw_pass_shader_resolve"
...
typedef struct VkDrawPassFragmentDensityMapCreateInfoEXT {
    VkStructureType          sType;
    const void*              pNext;
    VkAttachmentReference    fragmentDensityMapAttachment;
} VkDrawPassFragmentDensityMapCreateInfoEXT;
...
#define VK_QCOM_draw_pass_transform 1
#define VK_QCOM_DRAW_PASS_TRANSFORM_SPEC_VERSION 1
#define VK_QCOM_DRAW_PASS_TRANSFORM_EXTENSION_NAME "VK_QCOM_draw_pass_transform"
typedef struct VkDrawPassTransformBeginInfoQCOM {
    VkStructureType                  sType;
    void*                            pNext;
    VkSurfaceTransformFlagBitsKHR    transform;
} VkDrawPassTransformBeginInfoQCOM;

typedef struct VkCommandBufferInheritanceDrawPassTransformInfoQCOM {
    VkStructureType                  sType;
    void*                            pNext;
    VkSurfaceTransformFlagBitsKHR    transform;
    VkRect2D                         drawArea;
} VkCommandBufferInheritanceDrawPassTransformInfoQCOM;
...
#define VK_QCOM_draw_pass_store_ops 1
#define VK_QCOM_draw_pass_store_ops_SPEC_VERSION 2
#define VK_QCOM_draw_pass_store_ops_EXTENSION_NAME "VK_QCOM_draw_pass_store_ops"
